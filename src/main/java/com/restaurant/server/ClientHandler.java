...
public class ClientHandler implements Runnable {
    ...
    private final com.restaurant.service.DataStore dataStore;
    private final com.restaurant.service.MenuService menuService;
    private final com.restaurant.service.OrderService orderService;

    public ClientHandler(Socket socket, com.restaurant.service.DataStore ds,
                         com.restaurant.service.MenuService menuService, com.restaurant.service.OrderService orderService) {
        this.socket = socket;
        this.dataStore = ds;
